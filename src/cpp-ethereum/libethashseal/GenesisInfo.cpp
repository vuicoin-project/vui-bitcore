...
#include "genesis/vuicashTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::vuicashMainNetwork: return c_genesisInfoVuiCashMainNetwork;
	case Network::vuicashTestNetwork: return c_genesisInfoVuiCashTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::vuicashMainNetwork: return c_genesisStateRootVuiCashMainNetwork;
	case Network::vuicashTestNetwork: return c_genesisStateRootVuiCashTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
